...
select
    ...
    to_char(1234567, '9,999,999') -- 123,4567
from dual;
...
select
    ...
    to_char(sysdate, 'hh24:mi:ss'), --14:48:11
    to_char(sysdate, 'yyyy-mm-dd hh24:mi:ss'), --2026-01-23 14:48:43
    to_char(sysdate, 'day am hh:mi:ss') --금요일 오후 02:49:22
from dual;
...
select
    ...
    to_date('2026-01-23 12:30:40', 'yyyy-mm-dd hh24:mi:ss'), --26/01/23

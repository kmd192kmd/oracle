...
insert into tblUser values ('test', '테스트', '런닝,매뉴얼독서,필독서');
...
create table tblShop (
    ...
    qty number not null,                --수량
    regdate date default sysdate not null,
    id varchar2(30) not null references tblUser(id) --구매 고객(FK > PK)
);
...
-- A.3 신규 프로젝트 추가(O)
-- ORA-02291: 무결성 제약조건(HR.SYS_C008486)이 위배되었습니다- 부모 키가 없습니다
...
-- B. '홍길동' 퇴사
-- B.1 '홍길동' 삭제(O)
-- ORA-02292: 무결성 제약조건(HR.SYS_C008486)이 위배되었습니다- 자식 레코드가 발견되었습니다

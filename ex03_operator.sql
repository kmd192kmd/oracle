...
select 
    name,
    capital,
    -- name + capital --ORA-01722: 수치가 부적합합니다
    name || capital,
    name || ' : ' || capital
from tblCountry;
...
select *
from tblCountry
where continent = 'AS' or area > 100;
...
select hr.tblCountry.name, hr.tblCountry.capital from hr.tblCountry; //fm
